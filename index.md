...
* **Language Preference:** Selected display language (Portuguese, English, Spanish, French, or Italian).
* **Ad Consent Status:** Whether you have granted or denied consent for personalized advertising, as required by GDPR and LGPD.
...
Calculator Leankar uses **Google AdMob** to display banner advertisements. When ads are displayed, Google may collect:
...
This data is collected and processed by Google in accordance with [Google's Privacy Policy](https://policies.google.com/privacy). Calculator Leankar has no access to or control over the data Google collects.

---

## Ad Consent (UMP – User Messaging Platform)

To comply with GDPR and LGPD, Calculator Leankar uses the **Google User Messaging Platform (UMP)** to request your consent before displaying personalized advertisements.

* On first launch (and periodically as required by law), a consent dialog is presented.
* You may accept or decline personalized ads.
* If you decline, non-personalized ads may still be shown; Google may still collect limited technical data as described in their privacy policy.
* Your consent choice is stored locally on your device and can be updated via device system settings.
...
No data collected by Calculator Leankar is used for analytics, tracking, profiling, or advertising purposes on our end.
...
However, by using the app with ads enabled, **Google AdMob** receives data as described in the "Data Collected by Third-Party Services" section above.
...
Note: Ad-related data collected by Google is subject to Google's own data retention and deletion policies.

---

## App Permissions

Calculator Leankar requests only the permissions required for its functionality.

| Permission | Purpose |
|---|---|
| `INTERNET` | Required by Google AdMob to load and display advertisements |
| `ACCESS_NETWORK_STATE` | Required by Google AdMob to check network availability before loading ads |
...
* **Opt-out:** You can opt out of personalized ads in your device settings (Google Settings → Ads → Opt out of Ads Personalization)
...
Ad content served by Google AdMob is subject to Google's family and content policies. If you are a parent or guardian and have concerns about ad content, you may disable ads by adjusting consent preferences in device settings.
...
* Lawful basis for data processing (consent via UMP for personalized ads)
...
* **Withdraw consent** for personalized advertising at any time via device settings
* **Stop using** the application freely

For data collected by Google AdMob, exercise your rights directly through Google's tools: [https://myaccount.google.com/data-and-privacy](https://myaccount.google.com/data-and-privacy)

---

## International Data Transfers

Calculator Leankar itself does not transfer data internationally. However, Google AdMob may transfer data to servers in the United States and other countries. Such transfers are governed by Google's data transfer mechanisms in compliance with GDPR and applicable laws.

---

## Cookies and Tracking Technologies

Calculator Leankar does **not** use cookies or tracking pixels directly. Google AdMob may use advertising identifiers and similar technologies on Android devices to serve and measure ads. You can reset or limit the use of your advertising identifier in your device settings.
...
* Clear and transparent disclosure of third-party SDKs (Google AdMob)
...
**Applicable to:** Calculator Leankar v0.9.1+
...
* **Preferência de Idioma:** Idioma de exibição selecionado (Português, Inglês, Espanhol, Francês ou Italiano).
* **Status de Consentimento de Anúncios:** Se você concedeu ou recusou o consentimento para publicidade personalizada, conforme exigido pela LGPD e GDPR.
...
O Calculator Leankar utiliza o **Google AdMob** para exibir anúncios em banner. Quando anúncios são exibidos, o Google pode coletar:

* Identificadores de publicidade (ex.: Android Advertising ID)
* Endereço IP
...
Esses dados são coletados e processados pelo Google de acordo com a [Política de Privacidade do Google](https://policies.google.com/privacy?hl=pt-BR). O Calculator Leankar não tem acesso nem controle sobre os dados coletados pelo Google.

---

## Consentimento para Anúncios (UMP – User Messaging Platform)

Para cumprir a LGPD e o GDPR, o Calculator Leankar utiliza a **Plataforma de Mensagens ao Usuário do Google (UMP)** para solicitar seu consentimento antes de exibir anúncios personalizados.

* Na primeira execução (e periodicamente conforme exigido por lei), um diálogo de consentimento é apresentado.
* Você pode aceitar ou recusar anúncios personalizados.
* Caso recuse, anúncios não personalizados ainda poderão ser exibidos; o Google pode continuar coletando dados técnicos limitados conforme descrito em sua política de privacidade.
* Sua escolha de consentimento é armazenada localmente no seu dispositivo e pode ser atualizada nas configurações do sistema.
...
Nenhum dado coletado pelo Calculator Leankar é usado por nós para fins de análise, rastreamento, criação de perfis ou publicidade.
...
No entanto, ao usar o app com anúncios habilitados, o **Google AdMob** recebe dados conforme descrito na seção "Dados Coletados por Serviços de Terceiros".
...
Observação: os dados relacionados a anúncios coletados pelo Google estão sujeitos às próprias políticas de retenção e exclusão do Google.

---

## Permissões do App

O Calculator Leankar solicita apenas as permissões necessárias para seu funcionamento.

| Permissão | Finalidade |
|---|---|
| `INTERNET` | Necessária pelo Google AdMob para carregar e exibir anúncios |
| `ACCESS_NETWORK_STATE` | Necessária pelo Google AdMob para verificar a disponibilidade de rede antes de carregar anúncios |
...
* **Finalidade:** Exibir anúncios em banner dentro do app
* **Fornecedor:** Google LLC
* **Dados coletados:** Conforme descrito em "Dados Coletados por Serviços de Terceiros"
* **Política de Privacidade:** [https://policies.google.com/privacy?hl=pt-BR](https://policies.google.com/privacy?hl=pt-BR)
* **Como cancelar:** Você pode cancelar anúncios personalizados nas configurações do dispositivo (Configurações do Google → Anúncios → Cancelar personalização de anúncios)
...
O conteúdo dos anúncios veiculados pelo Google AdMob está sujeito às políticas de família e conteúdo do Google. Se você é pai, mãe ou responsável e tem preocupações com o conteúdo dos anúncios, pode desabilitar os anúncios personalizados nas configurações de consentimento do dispositivo.
...
* Base legal para o tratamento de dados (consentimento via UMP para anúncios personalizados)
...
* **Revogar o consentimento** para publicidade personalizada a qualquer momento nas configurações do dispositivo
* **Parar de usar** o aplicativo livremente

Para dados coletados pelo Google AdMob, exerça seus direitos diretamente pelas ferramentas do Google: [https://myaccount.google.com/data-and-privacy](https://myaccount.google.com/data-and-privacy)

---

## Transferências Internacionais de Dados

O Calculator Leankar em si não realiza transferências internacionais de dados. No entanto, o Google AdMob pode transferir dados para servidores nos Estados Unidos e em outros países. Tais transferências são regidas pelos mecanismos de transferência de dados do Google, em conformidade com o GDPR e as leis aplicáveis.

---

## Cookies e Tecnologias de Rastreamento

O Calculator Leankar **não** utiliza cookies ou pixels de rastreamento diretamente. O Google AdMob pode usar identificadores de publicidade e tecnologias similares em dispositivos Android para veicular e mensurar anúncios. Você pode redefinir ou limitar o uso do seu identificador de publicidade nas configurações do dispositivo.
...
* Divulgação clara e transparente de SDKs de terceiros (Google AdMob)
...
**Aplicável a:** Calculator Leankar v0.9.1+
